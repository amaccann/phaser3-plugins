...
export default class DemoScene extends Scene {
  ...
  setDemoKeyEvents() {
    ...
    keyboard.on('keydown-P', () => {
      ...
      if (this.isPaused) {
        this.gameObjectBrainPlugin.pauseAll();
      } else {
        this.gameObjectBrainPlugin.resumeAll();
      }
    });
  ...
  create() {
    this.gameObjectBrainPlugin = this.plugins.start('GameObjectBrainPlugin', 'gameObjectBrainPlugin');
    this.gameObjectBrainPlugin.setup({
      scene: this
    });
  ...
  update(time, delta) {
    ...
    // this.gameObjectBrainPlugin.update(time, delta);
